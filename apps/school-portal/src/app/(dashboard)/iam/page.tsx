...
export default function IAMPage() {
  const { data: roles } = useQuery({ queryKey: ['iam-roles'], queryFn: () => apiClient.iam.listRoles() });
  const { data: permissions } = useQuery({ queryKey: ['iam-permissions'], queryFn: () => apiClient.iam.listPermissions() });
